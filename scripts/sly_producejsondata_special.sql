if object_id('datalab.fos.special_json', 'u') is not null
	drop table datalab.fos.special_json;
...
select
	...
	case		-- type
		...
		when c.name = 'main_specialism' then 'lookup'
	...
	case		-- sortLookup (1=sort by text, 0=sort by code)
		...
		when c.name = 'main_specialism' then 0
	...
	case		-- description
		...
		when c.name='ptfsm6cla1a_ks2' then 'Percentage of pupils at the end of Key Stage 2 who are disadvantaged, 2018/19'
	...
	case		-- group
		...
		when c.name='main_specialism' then 'School characteristics'
		...
		when c.name='tks1average' then 'KS2 performance'
		when c.name='ptfsm6cla1a_ks2' then 'KS2 performance'
		when c.name='ptealgrp2_ks2' then 'KS2 performance'
		when c.name='ptnmob_ks2' then 'KS2 performance'
		when c.name='telig_2019' then 'KS2 performance'
		when c.name='readprog_2019' then 'KS2 performance'
		when c.name='writprog_2019' then 'KS2 performance'
		when c.name='matprog_2019' then 'KS2 performance'
		when c.name='ptrwm_exp_2019' then 'KS2 performance'
		when c.name='ptread_exp_2019' then 'KS2 performance'
		when c.name='ptmat_exp_2019' then 'KS2 performance'
		when c.name='ptwritta_exp_2019' then 'KS2 performance'
		when c.name='ptgps_exp_2019' then 'KS2 performance'
		when c.name='ks2aps' then 'KS4 performance'
		when c.name='ptfsm6cla1a_ks4' then 'KS4 performance'
		when c.name='ptealgrp2_ks4' then 'KS4 performance'
		when c.name='ptnmob_ks4' then 'KS4 performance'
		when c.name='tpup_2019' then 'KS4 performance'
		when c.name='p8pup_2019' then 'KS4 performance'
		when c.name='ptebacc_e_ptq_ee_2019' then 'KS4 performance'
		when c.name='ebaccaps_2019' then 'KS4 performance'
		when c.name='a8_2019' then 'KS4 performance'
		when c.name='p8_2019' then 'KS4 performance'
		when c.name='p8meaeng_2019' then 'KS4 performance'
		when c.name='p8meamat_2019' then 'KS4 performance'
		when c.name='p8meaebac_2019' then 'KS4 performance'
		when c.name='p8meaopen_2019' then 'KS4 performance'
	...
	case		-- isFilter
		when c.name='inResults' then 1
		when c.name='main_specialism' then 1
	...
	case		-- isVisible
		...
		when c.name='ptrwm_exp_2019' then 1
...
where
	object_id = object_id('datalab.fos.special')
...
update #meta set "lookup" = '[1,"Autistic spectrum disorder"],[2,"Hearing impairment"],[3,"Moderate learning difficulty"],[4,"Multi-sensory impairment/profound and multiple learning difficulty/severe learning difficulty"],[5,"Physical disability"],[6,"Social, emotional and mental health"],[7,"Speech, language and communication"],[8,"Specific learning difficulty"],[9,"Visual impairment"],[10,"Other/not recorded/not applicable"]' where column_name = 'main_specialism';

update #meta set "lookup" = '[1,"Outstanding"],[2,"Good"],[3,"Requires improvement"],[4,"Inadequate"]' where column_name = 'latest_ofsted';

update #meta set "lookup" = '[3,"Community/non-maintained school"],[2,"Foundation school"],[4,"Converter academy/city technology college"],[5,"Sponsored academy"],[6,"Free school"]' where column_name = 'schtype';

update #meta set "lookup" = '[1,"Primary"],[2,"Secondary"],[3,"All-through"]' where column_name = 'phase';
...
update #meta set chart='"xEnabled":true' where column_name='tfsm6cla1a_ks2';
...
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"KS2 reading pupils, 2019"' where column_name='readprog_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"KS2 writing pupils, 2019"' where column_name='writprog_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"KS2 maths pupils, 2019"' where column_name='matprog_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"KS2 pupils, 2019"' where column_name='ptrwm_exp_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"KS2 pupils, 2019"' where column_name='ptread_exp_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"KS2 pupils, 2019"' where column_name='ptmat_exp_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"KS2 pupils, 2019"' where column_name='ptwritta_exp_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"KS2 pupils, 2019"' where column_name='ptgps_exp_2019';
...
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"P8 pupils, 2019"' where column_name='p8_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"P8 pupils, 2019"' where column_name='p8meaeng_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"P8 pupils, 2019"' where column_name='p8meamat_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"P8 pupils, 2019"' where column_name='p8meaebac_2019';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"P8 pupils, 2019"' where column_name='p8meaopen_2019';
...
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"Teachers"' where column_name='pct_teachers_50';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"Teachers"' where column_name='pct_temp_posts';
update #meta set chart='"type":"scatter","xEnabled":true,"defaultX":"Teachers"' where column_name='pct_teachers_leadership';
...
update #meta set field_name = 'Main specialism' where column_name = 'main_specialism';
...
-- National averages
-- NB: no national averages are available from public data
